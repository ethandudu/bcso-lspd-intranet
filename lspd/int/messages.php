                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <script>
                                            function closemodal(){
                                                ...
                                                console.log(document.getElementById("officier_lspd").value);
                                                console.log(document.getElementById("officier_bcso").value);
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $req = $bdd->prepare('SELECT * FROM messages_lspd WHERE receiver = ? ORDER BY datetime DESC');
