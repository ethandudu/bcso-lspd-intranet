            ...
            <div id="content">
                <div class="">
                    ...
                    <div class="text-center">
                        <div class="error error2 mx-auto" data-text="Maintenance">Maintenance</div>
                        <p class="lead text-gray-800 mb-5">Le site est actuellement en maintenance</p>
                        <p class="text-gray-500 mb-0">On résout un bug dans la matrice...</p>
                    </div>
