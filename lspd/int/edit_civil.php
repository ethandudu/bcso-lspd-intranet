...
if (isset($_POST['submit'])) {
    ...
    if ($_COOKIE['grade'] != "Commandant"){
        $req = $bdd->prepare('UPDATE civils_lspd SET birthdate = ?, tel = ?, picface = ?, picback = ?, picright = ?, note = ? WHERE ID = ?');
        $req->execute(array($birthdate, $tel, $picface, $picback, $picright, $note, $id));
    } else {
        $name = $_POST['name'];
        $firstname = $_POST['firstname'];
        $req = $bdd->prepare('UPDATE civils_lspd SET name = ?, firstname= ?, birthdate = ?, tel = ?, picface = ?, picback = ?, picright = ?, note = ? WHERE ID = ?');
        $req->execute(array($name, $firstname, $birthdate, $tel, $picface, $picback, $picright, $note, $id));
    }
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="name" name="name" placeholder="Nom" value="<?php echo $name?>" <?php if ($_COOKIE['grade'] != "Commandant"){
                                    echo "disabled";
                                }?>>
                            </div>
                            <label for="firstname" class="col-sm-2 col-form-label">Prénom</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="firstname" name="firstname" placeholder="Prénom" value="<?php echo $firstname?>" <?php if ($_COOKIE['grade'] != "Commandant"){
                                    echo "disabled";
                                }?>>
                            </div>
