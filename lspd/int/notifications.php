...
<head>
    ...
    <title>Notifications - LSPD</title>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $req = $bdd->prepare('SELECT ID, type, sender, text, datetime, markasread, civilid FROM notifications_lspd WHERE receiver = ? ORDER BY datetime DESC');
                                        ...
                                        while ($data = $req->fetch()) {
                                            ...
                                            $reqsender = $bdd->prepare('SELECT matricule, name, firstname FROM members_lspd WHERE ID = ?');
                                            $reqsender->execute(array($data['sender']));
                                            $datasender = $reqsender->fetch();
                                            echo '<td>' . $datasender['matricule'] . ' | '. $datasender['firstname'] . ' ' . $datasender['name'] . '</td>';
