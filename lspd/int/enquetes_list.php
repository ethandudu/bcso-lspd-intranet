        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Enquêtes</h1>
                    <p class="mb-4">Toutes les enquêtes menées par le B.E.</p>
                    <p><label>Rechercher:
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <input type="button" class="btn btn-primary" value="Ajouter une enquête" onclick="window.location.href='add_enquete.php'">
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $req = $bdd->prepare('SELECT * FROM enquetes_lspd ORDER BY ID DESC');
                                        $req->execute();
                                        while ($data = $req->fetch()) {
                                            echo '<tr>';
                                            echo '<td>'.$data['Subject'];
                                            ...
                                            echo '<td><a href="details_enquete.php?id=' . $data['ID'] . '"><i class="fas fa-eye"></i></a> <a href="edit_enquete.php?id=' . $data['ID'] . '"><i class="fas fa-edit"></i></a> <a href="enquete_rapport.php?id='.$data['ID'].'"><i class="fas fa-file"></i></a> <a href="delete_enquete.php?id=' . $data['ID'] . '"><i class="fas fa-trash-alt"></i></a></td>';
                                        }
                                        ?>
