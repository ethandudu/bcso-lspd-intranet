        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Fiche civil BCSO</p>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-footer">
                            <a href="civils_bcso.php" class="btn btn-secondary">Retour</a>
                            <a href="export_casier_bcso.php?id=<?php echo $id;?>" class="btn btn-info">Casier judiciaire</a>
                            <a href="export_civil_bcso.php?id=<?php echo $id;?>" class="btn btn-success">Exporter</a>
                        </div>
                    </div>
