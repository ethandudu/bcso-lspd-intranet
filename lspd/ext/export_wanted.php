...
$req = $bdd -> prepare("SELECT * FROM wanted WHERE ID = ?");
$req -> execute(array($_GET['id']));
$wanted = $req -> fetch();

$reqcivil = $bdd -> prepare("SELECT * FROM civil WHERE ID = ?");
...
$pdf->Cell(40,6,utf8_decode($civil['adress']),0,1,'L',0);
...
$pic1 = "data:image/jpeg;base64,".$civil['picface'];
$pic2 = "data:image/jpeg;base64,".$civil['picback'];
$pic3 = "data:image/jpeg;base64,".$civil['picright'];
//show 3 pictures sides by sides
try {
