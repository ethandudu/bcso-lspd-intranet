        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Tous les civils recherchés</p>
                    <p><label>Rechercher:
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $req = $bdd->prepare('SELECT * FROM wanted ORDER BY `datetime` DESC');
                                        $req->execute();
                                        while ($data = $req->fetch()) {
                                            $req2 = $bdd->prepare('SELECT name, firstname FROM civil WHERE ID = ?');
                                            ...
                                            echo '<td><a href="details_wanted.php?id=' . $data['ID'] . '"><i class="fas fa-eye"></i></a></td>';
