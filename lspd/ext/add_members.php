...
if (isset($_POST['submit'])) {
    ...
    $req = $bdd->prepare('INSERT INTO externs (name, firstname, username, grade, password) VALUES (?, ?, ?, ?, ?)');
    $req->execute(array($name, $firstname, $username, $grade, $passwordhashed));
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Ajouter un utilisateur</p>                    
