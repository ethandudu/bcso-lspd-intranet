                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $req = $bdd->prepare('SELECT name, firstname, birthdate, skin, hair, tel, adress, ID FROM civil ORDER BY name');
                                        $req->execute();
                                        while ($data = $req->fetch()) {
                                            ...
                                            echo '<td><a href="details_civils.php?id=' . $data['ID'] . '"><i class="fas fa-eye"></i></a></td>';
                                        }
                                        ?>
