        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Tous les utilisateurs enregistrés</p>
                    <p><label>Rechercher:
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <input type="button" class="btn btn-primary" value="Ajouter un utilisateur" onclick="window.location.href='add_members.php'">
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $req = $bdd->prepare('SELECT * FROM externs');
                                        $req->execute();
                                        while ($data = $req->fetch()) {
                                            ...
                                            echo '<td><a href="edit_member.php?id='.$data['ID'].'"><i class="fas fa-edit"></i></a> <a href="delete_member.php?id=' . $data['ID'] . '"><i class="fas fa-trash-alt"></i></a></td>';
                                        }
                                        ?>
