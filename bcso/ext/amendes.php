        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Amendes</h1>
                    <br>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tableau des amendes</h6>
                        </div>
                        <div class="card-body">
                            <iframe src="https://docs.google.com/spreadsheets/d/1WdYzjKyysaOTnMR_fs4B8H-k6MhQmTOueRrEAKXtFH8/edit#gid=0" width="100%" height="700px" crossorigin="anonymous"></iframe>
                        </div>
                    </div>
