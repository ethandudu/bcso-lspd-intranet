...
if (isset($_POST['submit'])) {
    $note = ($_POST['editor']);
    $reqnote = $bdd->prepare("UPDATE members_bcso SET note = ? WHERE ID = ?");
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-6 mb-4">
                                <?php
                                    $req = $bdd->prepare('SELECT defcon_bcso FROM settings');
                                    $req->execute();
                                    $defcon=$req->fetch();

                                    if ($defcon['defcon_bcso'] == 5){
                                        $text = '<span class="badge badge-success">5</span>';
                                        $color = 'success';
                                        $pic = 'defcon-5.png';
                                    } elseif ($defcon['defcon_bcso'] == 4){
                                        $text = '<span class="badge badge-info">4</span>';
                                        $color = 'info';
                                        $pic = 'defcon-4.png';
                                    } elseif ($defcon['defcon_bcso'] == 3){
                                        $text = '<span class="badge badge-purple">3</span>';
                                        $color = 'purple';
                                        $pic = 'defcon-3.png';
                                    } elseif ($defcon['defcon_bcso'] == 2){
                                        $text = '<span class="badge badge-warning">2</span>';
                                        $color = 'warning';
                                        $pic = 'defcon-2.png';
                                    } elseif ($defcon['defcon_bcso'] == 1){
                                ...
                                <div class="card border-left-<?php echo $color?> shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-<?php echo $color?> text-uppercase mb-1">Defcon BCSO</div>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                        <?php
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <form method="post" name="savenote" >
                                    <!-- display text editor -->
                                        ...
                                        $req = $bdd->prepare('SELECT note FROM members_bcso WHERE ID = ?');
