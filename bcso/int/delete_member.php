...
if (isset($_POST['delete-confirmation'])) {
    $id = $_GET['id'];
    $req = $bdd->prepare('DELETE FROM members_lspd WHERE ID = ?');
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form class="user" method="post" name="delete-confirm">
                                ...
                                <a href="list_members.php" class="btn btn-secondary btn-user btn-block" value="Annuler">Annuler</a>
                            </form>
                            <hr>
                        </div>
                    </div>
