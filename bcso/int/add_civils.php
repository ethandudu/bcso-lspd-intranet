            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form method="POST" name="newcasier" enctype="multipart/form-data" autocomplete="off">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" id="inputBirthdate" name="inputBirthdate" placeholder="Date de naissance" pattern="\d{4}-\d{2}-\d{2}" placeholder="MM/DD/YYYY" required>
                                    </div>
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="img1" name="img1" placeholder="">
                                    </div>
                                    <label for="img2" class="col-sm-2 col-form-label">Photo de profil</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="img2" name="img2" placeholder="">
                                    </div>
                                    <label for="img3" class="col-sm-2 col-form-label">Photo de dos</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="img3" name="img3" placeholder="">
                                    </div>
