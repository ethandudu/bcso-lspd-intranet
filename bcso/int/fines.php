...
<head>
    ...
    <title>Amendes impayées - BCSO</title>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $req = $bdd->prepare('SELECT * FROM fines_bcso ORDER BY factureid ASC');
                                        $req->execute();
                                        while ($data = $req->fetch()) {
                                            echo '<tr>';
                                            echo '<td>' . $data['factureid'] . '</td>';
                                            $reqcivil = $bdd->prepare('SELECT name, firstname from civils_bcso WHERE ID = ?');
                                            ...
                                            echo '<td>' . $officer['name'] ." ".$officer['firstname'].'</td>';
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <label for="adressdetail">Adresse</label>
                    <input type="text" class="form-control" id="adressdetail" name="adressdetail" placeholder="" required autocomplete="off" disabled>
                        ...
                        function loadcivil(id) {
                            ...
                            $.ajax({
                                ...
                                success: function(data){
                                    ...
                                    document.getElementById("adressdetail").value = res[0].address;
