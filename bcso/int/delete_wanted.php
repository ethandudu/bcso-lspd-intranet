                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Voulez-vous vraiment supprimer le wanted de <?php echo $namefirstname ?> ?</h1>
                            </div>
                            <form class="user" method="post" name="delete-confirm">
                                ...
                                <a href="wanted.php" class="btn btn-secondary btn-user btn-block" value="Annuler">Annuler</a>
                            </form>
                            <hr>
                        </div>
                    </div>
