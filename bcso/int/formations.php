...
session_start();
include('../config.php');
include('functions/formationsverif.php');
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <iframe src="https://docs.google.com/spreadsheets/d/1NSgF5BnLNBfqYgThPw6NXFWEoFVhKfSZ6BqyP2ivprk/edit?usp=sharing" width="100%" height="700px"></iframe>
                        </div>
                    </div>
