        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Tous les casiers judiciaires enregistrés</p>
                    <p><label>Rechercher:
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <input type="button" class="btn btn-primary" value="Ajouter un casier judiciaire" onclick="window.location.href='add_casier.php'">
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-stripped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $req = $bdd->prepare('SELECT * FROM casiers');
                                        $req->execute();
                                        while ($data = $req->fetch()) {
                                            $req2 = $bdd->prepare('SELECT * FROM civil WHERE ID = ?');
                                            ...
                                            $req2 = $bdd->prepare('SELECT * FROM members WHERE ID = ?');
