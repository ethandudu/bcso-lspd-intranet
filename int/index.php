...
if (isset($_POST['savenote'])) {
    ...
    $reqnote = $bdd->prepare("UPDATE members SET note = ? WHERE ID = ?");
    $reqnote->execute(array($note, $_SESSION['id']));
}
?>
<!DOCTYPE html>
<html lang="fr">
                        ...
                        <div class="col-xl col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <form method="POST" name="savenote">
                                    <!-- display text editor -->
                                    <textarea id="note" name="note" class="form-control" rows="10" cols="50" placeholder="Saisissez votre note ici">
                                        <?php
                                            $reqnote = $bdd->prepare('SELECT note FROM members WHERE ID = '.$_SESSION['id'].'');
                                            $reqnote->execute();
                                            $note=$reqnote->fetchAll();
                                            echo($note['note']);
                                            ?>
                                    </textarea><br>
