...
if (isset($_POST['delete-confirmation'])) {
    $id = $_GET['id'];
    $req = $bdd->prepare('DELETE FROM civil WHERE ID = ?');
...
$namefirstname = $req2['name'] . ' ' . $req2['firstname'];
?>
<!DOCTYPE html>
<html lang="fr">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form class="user" method="post" name="delete-confirm">
                                ...
                                <a href="civils.php" class="btn btn-secondary btn-user btn-block" value="Annuler">Annuler</a>
                            </form>
                            <hr>
                        </div>
                    </div>
