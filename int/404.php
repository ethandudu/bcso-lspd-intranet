            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-500 mb-0">Tu as trouvé un bug dans la matrice</p>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; BCSO - Amercian Stories 2022</span><br>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-secondary btn-warning" type="button" data-dismiss="modal">Cancel</button>
                    <a class="btn btn-primary btn-success" href="logout.php">Logout</a>
                </div>
            </div>
        </div>
    </div>
