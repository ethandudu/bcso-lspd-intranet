...
if (isset($_POST['submit'])) {
    ...
    $req = $bdd->prepare('INSERT INTO casiers (civilid, crime, sanction, datetime, officier, note) VALUES (:civilid, :crime, :sanction, :date, :officier, :note)');
    $req->execute(array(
        'civilid' => $civilid,
        'crime' => $crime,
        'sanction' => $sanction,
                            ...
                            <form method="POST" name="newcasier">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <select class="form-control" name="inputName" id="inputName" required>
                                            <?php
                                                $req = $bdd->query('SELECT * FROM civil');
