...
if (isset($_POST['submit'])) {
    ...
    $req = $bdd->prepare('UPDATE civil SET birthdate = ?, skin = ?, hair = ?, tel = ?, adress = ?, note = ? WHERE ID = ?');
    $req->execute(array($birthdate, $skin, $hair, $tel, $address, $note, $id));

    if (isset($_FILES['pica'])) {
        ...
        $req = $bdd->prepare('UPDATE civil SET pica = ? WHERE ID = ?');
        $req->execute(array($imgcontent1, $id));
    }

    if (isset($_FILES['picb'])) {
        ...
        $req = $bdd->prepare('UPDATE civil SET picb = ? WHERE ID = ?');
        $req->execute(array($imgcontent2, $id));
    }
    ...
    if (isset($_FILES['picc'])) {
        ...
        $req = $bdd->prepare('UPDATE civil SET picc = ? WHERE ID = ?');
        $req->execute(array($imgcontent3, $id));
    }
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="birthdate" name="birthdate" placeholder="Date de naissance" value="<?php  echo $birthdate;?>">
                            </div>
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="skin" name="skin" placeholder="Peau" value="<?php  echo $skin;?>">
                            </div>
                            <label for="hair" class="col-sm-2 col-form-label">Cheveux</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="hair" name="hair" placeholder="Cheveux" value="<?php  echo $hair;?>">
                            </div>
